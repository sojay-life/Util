...
/**
 * 字符串操作
 * Created by Jesse_Chin on 15/12/1.
 */
public class StringUtils {
    ...
    /**
     * 获取真正的字符串长度.区分中英文,英文1个字符,中文2个字符.可以中英文混合.
     * @param inputStr 需要检测的字符串
     * @return 英文1,中文2 的长度
     */
    ...
    /**
     * 获取限制的真正的字符串长度内的内容.区分中英文,英文1个字符,中文2个字符.可以中英文混合.
     * @param inputStr 需要检测的字符串
     * @param limit     限制的长度
     * @return 限制长度内的内容
     */
    public static String getStringTrueLenghtLimit(String inputStr, int limit){
        int orignLen = inputStr.length();
        int resultLen = 0;
        String temp = null;
        StringBuilder sb = new StringBuilder();
